...
export const sections: NavSection[] = [
  {
    ...
    items: [
      ...
      { slug: 'trayectoria-del-estudiante', label: 'Trayectoria del estudiante' },
      { slug: 'gestion-curricular', label: 'Gestión curricular' },
      { slug: 'syllabus-cic', label: 'Syllabus CIC' },
      { slug: 'syllabus-iee', label: 'Syllabus IEE' },
      ...
      { slug: 'reglamento', label: 'Reglamento' },
